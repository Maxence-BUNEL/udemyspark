object LearningScala1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(2577); 
 def main(args: Array[String]) {
  ...
  val pivalue: Float = 3.14159265f
  var pix2: Float = pivalue*2
  println(pix2%4d)
